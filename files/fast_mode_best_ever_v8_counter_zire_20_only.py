...
def farzam_indicators(open, high, low, close, parameters_input):
    ...
    conditions = pd.concat([long_entry_cond, short_entry_cond, top, bot, diff, close,counter], axis=1).rename(columns={0: "long_entry_cond", 1: "short_entry_cond", 2: "top", 3: "bot", "close_price": "close"})
